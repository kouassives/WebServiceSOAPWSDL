 ...
 * 
 */
@WebServiceClient(name = "MonServiceService", targetNamespace = "http://messervices/", wsdlLocation = "http://localhost:8085/services?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8085/services?wsdl");
